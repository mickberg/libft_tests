...
#    Updated: 2019/11/06 20:39:52 by mikaelber        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = ft_strlen.c ft_toupper.c ft_tolower.c ft_strcmp.c ft_strncmp.c \
	ft_itoa.c ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c \
